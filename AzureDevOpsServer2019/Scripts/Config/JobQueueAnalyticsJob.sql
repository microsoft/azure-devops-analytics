-- Get the job queue Analytics staging and transform jobs.

SELECT  JobId, Priority, QueueTime, JobSource, JobState, ExecutionStartTime, StateChangeTime,
			QueuedReasons, QueueFlags, RequeueJob, RequeuePriority, RequeueDelaySeconds
FROM    dbo.tbl_JobQueue
WHERE    
    (
